export const proseShellClasses = [
	...
	'[&_p]:text-[1.1rem] [&_p]:leading-[2] [&_p]:tracking-[0.01em] [&_p]:font-medium [&_p]:text-slate-300 [&_p]:my-3 [&_p]:mb-4',
	'[&_li]:text-[1.1rem] [&_li]:leading-[2] [&_li]:tracking-[0.01em] [&_li]:font-medium [&_li]:text-slate-300 [&_li]:my-1.5',
	'[&_td]:text-[1.02rem] [&_td]:leading-[1.7] [&_td]:tracking-[0.01em] [&_td]:font-medium [&_td]:text-slate-300',
	'[&_th]:text-[0.88rem] [&_th]:leading-[1.4] [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-[0.08em] [&_th]:text-slate-200',
	'[&_h1]:text-slate-50 [&_h1]:tracking-[0.01em] [&_h1]:text-[2.2rem] [&_h1]:font-bold',
	'[&_h2]:mt-[2.65rem] [&_h2]:mb-4 [&_h2]:text-[1.85rem] [&_h2]:leading-[1.18] [&_h2]:tracking-[0.01em] [&_h2]:text-slate-50 [&_h2]:font-bold [&_h2]:border-b [&_h2]:border-white/8 [&_h2]:pb-3',
	'[&_h3]:mt-[2.2rem] [&_h3]:mb-3 [&_h3]:text-[1.35rem] [&_h3]:leading-[1.35] [&_h3]:tracking-[0.01em] [&_h3]:text-slate-50 [&_h3]:font-semibold',
	'[&_h4]:mt-[1.8rem] [&_h4]:mb-2 [&_h4]:text-[1.15rem] [&_h4]:leading-[1.4] [&_h4]:tracking-[0.01em] [&_h4]:text-slate-50 [&_h4]:font-semibold',
	...
	'[&_ul]:pl-5 [&_ol]:pl-5 [&_ul]:my-4 [&_ol]:my-4 [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:space-y-2 [&_ol]:space-y-2',
	'[&_table]:my-6 [&_table]:w-full [&_table]:border-collapse [&_table]:bg-white/3',
	'[&_thead]:bg-white/8',
	'[&_tbody_tr:nth-child(odd)]:bg-white/3',
	'[&_tbody_tr:nth-child(even)]:bg-white/7',
	'[&_tbody_tr:hover]:bg-white/10',
	...
	'[&_[data-todo-line]]:bg-amber-500/12 [&_[data-todo-line]]:border-l-[3px] [&_[data-todo-line]]:border-l-amber-400 [&_[data-todo-line]]:rounded-r-sm',
	'[&_[data-code-block]_[data-todo-line]]:bg-amber-500/12 [&_[data-code-block]_[data-todo-line]]:border-l-[3px] [&_[data-code-block]_[data-todo-line]]:border-l-amber-400',
