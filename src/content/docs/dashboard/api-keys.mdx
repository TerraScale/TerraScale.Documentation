...
<Tabs items={[{"label":"Active","content":"<p>The key is valid and can be used for API requests.</p>\n<pre><code>- Green status indicator\n- Can be revoked at any time\n- Shows last used timestamp\n</code></pre>"},{"label":"Revoked","content":"<p>The key has been manually disabled and cannot be used.</p>\n<pre><code>- Red status indicator\n- Revocation is permanent\n- Cannot be re-activated\n</code></pre>"},{"label":"Expired","content":"<p>The key has passed its expiration date.</p>\n<pre><code>- Yellow status indicator\n- Automatically stops working at expiration\n- Cannot be extended\n</code></pre>"}]} />
