...
<CardGrid items={[{"title":"Current Plan","icon":"star","content":"<p>Your active subscription tier and status.</p>"},{"title":"Usage","icon":"chart","content":"<p>Current usage against plan limits.</p>"},{"title":"Next Invoice","icon":"document","content":"<p>Upcoming charge amount and date.</p>"},{"title":"Payment Method","icon":"credit-card","content":"<p>Default payment method on file.</p>"}]} />
...
<Tabs items={[{"label":"Active","content":"<p>Your subscription is current and fully functional.</p>"},{"label":"Trialing","content":"<p>You&#39;re in a free trial period. Add a payment method before the trial ends to continue.</p>"},{"label":"Past Due","content":"<p>Payment failed. Update your payment method to restore full access.</p>"},{"label":"Cancelled","content":"<p>Subscription cancelled. Access continues until the end of the billing period.</p>"}]} />
